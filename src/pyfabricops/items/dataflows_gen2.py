...
def get_dataflow_gen2_id(workspace: str, dataflow_gen2_name: str) -> Union[str, None]:
    """
    ...
    for _dataflow in dataflows:
        if _dataflow['displayName'] == dataflow_gen2_name:
            return _dataflow['id']
    logger.warning(f"Dataflow '{dataflow_gen2_name}' not found in workspace '{workspace}'.")
    return None
...
def get_dataflow_gen2_definition(workspace: str, dataflow: str) -> Union[Dict[str, str], None]:
    """
